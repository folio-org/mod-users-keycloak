...
public abstract class BaseIntegrationTest extends BaseBackendIntegrationTest {
  ...
  public static final String FOLIO_ENTITLEMENT_CONFIRMATION_TOPIC = "it-test.entitlement-confirmation";
  ...
  public static class TopicConfiguration {
    ...
    @Bean
    public NewTopic entitlementConfirmationTopic() {
      return new NewTopic(FOLIO_ENTITLEMENT_CONFIRMATION_TOPIC, 1, (short) 1);
    }

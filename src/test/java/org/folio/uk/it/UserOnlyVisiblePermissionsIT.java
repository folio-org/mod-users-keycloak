...
@IntegrationTest
@TestPropertySource(properties = "application.mod-roles-keycloak.include-only-visible-permissions=true")
class UserOnlyVisiblePermissionsIT extends BaseIntegrationTest {
  ...
  void getBySelf_onlyVisiblePermissions() throws Exception {
    mockMvc.perform(get("/users-keycloak/_self?include=groups")
      ...
      .andExpect(jsonPath("$.permissions.permissions", is(List.of("ui.all"))))
